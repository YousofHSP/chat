...
namespace Common.Utilities
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void AddDefaultValueSqlConvertion(this ModelBuilder modelBuilder, string propertyName, Type propertyType, string defaultValueSql)
        {
            foreach (IMutableEntityType entityType in modelBuilder.Model.GetEntityTypes())
            {
        ...
        public static void AddSequentialGuidForIdConverntion(this ModelBuilder modelBuilder)
        {
            modelBuilder.AddDefaultValueSqlConvertion("Id", typeof(Guid), "NEWSEQUENTIALID()");
        }
